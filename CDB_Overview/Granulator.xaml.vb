...
Public Class Granulator
    ...
    Public Sub New()
        ...
        sPageType = "Granulator"
        '
        Dim sTags(2) As String

        sTags(0) = "XHN_GAS-PLNT_MTR-SKID-MTR-1_IFRT.PV"
        ...
        pi_col_xls_tags(1) = "XHN_GAS-PLNT_MTR-SKID-MTR-1_IFRT.PV"
        pi_col_xls_tags(2) = "XHN_GAS-PLNT_MTR-SKID-MTR-2_IFRT.PV"
        pi_col_xls_tags(3) = "XHN_GAS-PLNT_MTR-SKID-MTR-3_IFRT.PV"
    ...
    Public Sub createPage(ByVal sArea As String, ByVal sPipe As String, ByVal sPageType As String)
        ...
        '   mysr = New StreamReader(filename)
        '   root = XamlReader.Load(mysr.BaseStream)
        ...
        For i = nSeries_from To nSeries_from + nSeries - 1
            ...
            For j = 0 To iPoints_as(i) - 1
                ...
                Try
                    ...
                    If ser.RenderAs = RenderAs.Column Or ser.RenderAs = RenderAs.StackedColumn Then
