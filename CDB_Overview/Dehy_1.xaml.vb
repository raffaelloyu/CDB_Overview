...
Public Class Dehy_1
    ...
    Public Sub createPage(ByVal sArea As String, ByVal sPipe As String, ByVal sPageType As String)
        ...
        If sPageType = "Dehy_1" Then
            '     Call createDehy()
        End If

    End Sub
    Private Sub createDehy()
    ...
    'Private Sub mini_me_MouseEnter(sender As Image, e As MouseEventArgs) Handles mini_me.MouseEnter         'no comments buddy.
    '    If imini_me = 0 Then
    '        imini_me = 1
    '        'Canvas.Left="393" Canvas.Top="54"
    '        Canvas.SetLeft(mini_me, 393)
    '        Canvas.SetTop(mini_me, 54)
    '    ElseIf imini_me = 1 Then
    '        imini_me = 2
    '        'Canvas.Left="807" Canvas.Top="328" 
    '        Canvas.SetLeft(mini_me, 807)
    '        Canvas.SetTop(mini_me, 328)
    '    Else
    '        mini_me.Height = 0
    '        mini_me.Width = 0
    '    End If
