...
Public Class TEGCompressor2
    ...
    Public Sub New()
        ...
        sPageType = "TEGCompressor2"
        '
        '
        Dim sTags(4) As String

        sTags(0) = "XHN_GS-B_ACID-GAS-COMP-2_STG-1-DP.PV"
        sTags(1) = "XHN_GS-B_ACID-GAS-COMP-2_STG-2-DP.PV"
        sTags(2) = "XHN_GS-B_ACID-GAS-COMP-2_STG-3-DP.PV"
        sTags(3) = "XHN_GS-B_ACID-GAS-COMP-2_STG-4-DP.PV"
        sTags(4) = "XHN_GS-B_ACID-GAS-COMP-2_STG-5-DP.PV"
        ...
        pi_col_xls_tags(1) = "XHN_GS-B_ACID-GAS-COMP-2_STG-1-DP.PV"
        pi_col_xls_tags(2) = "XHN_GS-B_ACID-GAS-COMP-2_STG-2-DP.PV"
        pi_col_xls_tags(3) = "XHN_GS-B_ACID-GAS-COMP-2_STG-3-DP.PV"
        pi_col_xls_tags(4) = "XHN_GS-B_ACID-GAS-COMP-2_STG-4-DP.PV"
        pi_col_xls_tags(5) = "XHN_GS-B_ACID-GAS-COMP-2_STG-5-DP.PV"
    ...
    Public Sub createPage(ByVal sArea As String, ByVal sPipe As String, ByVal sPageType As String)
        ...
        If sPageType = "TEGCompressor2" Then
