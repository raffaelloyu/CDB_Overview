...
Public Class NGP_profile
            ...
            Try
                ...
                ElseIf sType = "animation" Then
                    If OSIsoft.AF.PI.PIPoint.TryFindPIPoint(srvAF, kida.ElementPITag, sinusoid) Then
                        ...
                        myP = sinusoid.CurrentValue()
                        element = kida.ElementXML.Clone
                        Call elementTest(kida, element, myP.Value, "animation", sEx)
                        kida.ElementXML = element
                ...
                ElseIf sType = "animation_analog" Then
                    If OSIsoft.AF.PI.PIPoint.TryFindPIPoint(srvAF, kida.ElementPITag, sinusoid) Then
                        ...
                        If myP.IsGood Then
                            element = kida.ElementXML.Clone
                            Call elementTest(kida, element, myP.Value, "animation_analog", sEx)
                            kida.ElementXML = element
                            If element.SelectSingleNode("cursta").InnerText = "on" Then
    ...
    Private Sub elementTest(ByRef kida As testpu, ByRef element As Xml.XmlNode, ByVal curval As Object, ByVal sType As String, ByVal sEx As String)
        ' Dim element As Xml.XmlNode = kida.ElementXML
        'Dim sEx As String
    ...
    Private Sub NGP_profile_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
    ...
    Private Sub NGP_profile_SizeChanged(sender As Object, e As SizeChangedEventArgs) Handles Me.SizeChanged
        oTransform1.BeginAnimation(RotateTransform.AngleProperty, oWeelAuto1)
        oTransform0.BeginAnimation(RotateTransform.AngleProperty, oWeelAuto0)
