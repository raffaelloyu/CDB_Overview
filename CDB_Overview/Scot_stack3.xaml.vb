...
Public Class Scot_stack3
    ...
    Private Sub createScock_stack()
        ...
        sTags(0) = "AI070988_3.PV"
        ' sTags(1) = "AI070988A_1.PV"
        sTags(1) = "AI070989_3.PV"
        sTags(2) = "AI070990_3.PV"
        sTags(3) = "AI070991_3.PV"
        ...
        sTags(0) = "XHN_GAS-PLNT_TRN-3_STACK_SO2-ANLYZR-1.PV"
        sTags(1) = "AIC070906_3.DACA.PV"
        ...
        pi_col_xls_tags(1) = "XHN_GAS-PLNT_TRN-3_STACK_SO2-ANLYZR-1.PV"
        pi_col_xls_tags(2) = "AI070988_3.PV"
    ...
    Private Sub Scot_stack3_SizeChanged(sender As Object, e As SizeChangedEventArgs) Handles Me.SizeChanged
    ...
    Private Sub Scot_stack3_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
