...
Public Class TEGCompressor1
    ...
    Public Sub New()
        ...
        sPageType = "TEGCompressor1"
        '
        '
        Dim sTags(4) As String

        sTags(0) = "XHN_GS-B_ACID-GAS-COMP-1_STG-1-DP.PV"
        sTags(1) = "XHN_GS-B_ACID-GAS-COMP-1_STG-2-DP.PV"
        ...
        pi_col_xls_tags(1) = "XHN_GS-B_ACID-GAS-COMP-1_STG-1-DP.PV"
        pi_col_xls_tags(2) = "XHN_GS-B_ACID-GAS-COMP-1_STG-2-DP.PV"
    ...
    Public Sub createPage(ByVal sArea As String, ByVal sPipe As String, ByVal sPageType As String)
        ...
        If sPageType = "TEGCompressor1" Then
