...
Public Class SulfurRemoval3
    ...
    Public Sub createPage(ByVal sArea As String, ByVal sPipe As String, ByVal sPageType As String)
        ...
        If sPageType = "SulfurRemoval3" Then
    ...
    Private Sub createTEGCompressor()
        ...
        sTags(0) = "FIC070602_3.DACA.PV"
        sTags(1) = "XHN_GAS-PLNT_TRN-3_WET-TREAT-GAS-KO-DRUM_GAS-OUTLET-IFRT.PV"
        ...
        pi_col_xls_tags(1) = "FIC070602_3.DACA.PV"
        pi_col_xls_tags(2) = "XHN_GAS-PLNT_TRN-3_WET-TREAT-GAS-KO-DRUM_GAS-OUTLET-IFRT.PV"
        ...
        sTags(0) = "XHN_GAS-PLNT_TRN-3_LEAN-SLFNL-COOLR_INLET-IFRT.PV"
        sTags(1) = "XHN_GAS-PLNT_TRN-3_HP-LEAN-SLFNL-PMP_DISCH-IFRT.PV"
        ...
        pi_col_xls_tags(1) = "XHN_GAS-PLNT_TRN-3_LEAN-SLFNL-COOLR_INLET-IFRT.PV"
        pi_col_xls_tags(2) = "XHN_GAS-PLNT_TRN-3_HP-LEAN-SLFNL-PMP_DISCH-IFRT.PV"
