...
Public Class TEGCompressor3
    ...
    Public Sub New()
        ...
        sPageType = "TEGCompressor3"
        '
        '
        Dim sTags(4) As String

        sTags(0) = "XHN_GS-B_ACID-GAS-COMP-3_STG-1-DP.PV"
        sTags(1) = "XHN_GS-B_ACID-GAS-COMP-3_STG-2-DP.PV"
        sTags(2) = "XHN_GS-B_ACID-GAS-COMP-3_STG-3-DP.PV"
        sTags(3) = "XHN_GS-B_ACID-GAS-COMP-3_STG-4-DP.PV"
        sTags(4) = "XHN_GS-B_ACID-GAS-COMP-3_STG-5-DP.PV"

        foundPoints = OSIsoft.AF.PI.PIPoint.FindPIPoints(srvAF, sTags)
        pts = New OSIsoft.AF.PI.PIPointList(foundPoints)

        ReDim pi_col_xls_tags(5)

        pi_col_xls_tags(1) = "XHN_GS-B_ACID-GAS-COMP-3_STG-1-DP.PV"
        pi_col_xls_tags(2) = "XHN_GS-B_ACID-GAS-COMP-3_STG-2-DP.PV"
        pi_col_xls_tags(3) = "XHN_GS-B_ACID-GAS-COMP-3_STG-3-DP.PV"
        pi_col_xls_tags(4) = "XHN_GS-B_ACID-GAS-COMP-3_STG-4-DP.PV"
        pi_col_xls_tags(5) = "XHN_GS-B_ACID-GAS-COMP-3_STG-5-DP.PV"
    ...
    Public Sub createPage(ByVal sArea As String, ByVal sPipe As String, ByVal sPageType As String)
        ...
        If sPageType = "TEGCompressor3" Then
    ...
    Private Sub refreshChart(ByVal sChartName As String)
        ...
        For i = 0 To 4
            ...
            rValues_as(0, i) = FormatNumber(avalue.Value, 0)
            sDates_as(0, i) = "Stage " & i + 1

        Next
        iPoints_as(0) = 5

        'Height="228" Canvas.Left="1330" Stroke="Gray" Canvas.Top="794" Width="489"
        'Height="231" Canvas.Left="911" Stroke="Transparent" Canvas.Top="443" Width="232"
        ...
        '  For ii1 = 1 To 5
        sTYpes(1) = RenderAs.Column
        sColors(1) = New SolidColorBrush(ColorConverter.ConvertFromString("#FF6B8EAD")) '#FFC6BEC6
        '        sSeriesNames(ii1) = "Stage " & ii1
        '    Next
        ...
        Call createNewChart(cha, sChartName, ileft, iTop,
                            ...
                            sTYpes, sColors, iPoints, "kPA")
        cha.AxesY(0).AxisMinimum = 0
        cha.AxesY(0).AxisMaximum = 6500
        cha.AxesY(0).Interval = 1000
    End Sub
    Private Sub UpdateLiveChart(ByRef chaName As String)
        ...
        For Each dp In cha.Series(0).DataPoints

            If results(i1).IsGood Then

                dp.YValue = FormatNumber(results(i1).Value, 0) '* rTags(i1)
    ...
    Private Sub createNewChart(ByRef cha As Chart, ByVal chaName As String, ByVal iLeft As Integer, ByVal iTop As Integer,
        ...
        myaxL.FontColor = Brushes.DarkGray
