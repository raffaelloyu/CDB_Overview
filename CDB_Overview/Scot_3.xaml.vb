...
Public Class Scot_3
    ...
    Public Sub New()
        ...
        imgPrint.AddHandler(PreviewMouseDownEvent, New RoutedEventHandler(AddressOf printXPS))
    ...
    Public Sub startScotprofile()
        Call writeToLog("ScotProfile 3")
        Dim newdia As New Scot_reactor_3
        newdia.Show()
    ...
    Private Sub printXPS()
        ...
        prdlg.PrintTicket.PageOrientation = System.Printing.PageOrientation.Landscape
    ...
    Private Sub createScot()
        ...
        sTags(0) = "XHN_GAS-PLNT_TRN-3_QNCH-COLUMN_H2-ANLYZR-1.PV"
        sTags(1) = "XHN_GAS-PLNT_TRN-3_QNCH-COLUMN_H2-ANLYZR-2.PV"
        ...
        pi_col_xls_tags(1) = "XHN_GAS-PLNT_TRN-3_QNCH-COLUMN_H2-ANLYZR-1.PV"
        pi_col_xls_tags(2) = "XHN_GAS-PLNT_TRN-3_QNCH-COLUMN_H2-ANLYZR-2.PV"
        ...
        sTags(0) = "XHN_GAS-PLNT_TRN-3_QNCH-H2O-FLTR_OUTLET-PH-MONITOR-1.PV"
        sTags(1) = "XHN_GAS-PLNT_TRN-3_QNCH-H2O-FLTR_OUTLET-PH-MONITOR-2.PV"
        ...
        pi_col_xls_tags(1) = "XHN_GAS-PLNT_TRN-3_QNCH-H2O-FLTR_OUTLET-PH-MONITOR-1.PV"
        pi_col_xls_tags(2) = "XHN_GAS-PLNT_TRN-3_QNCH-H2O-FLTR_OUTLET-PH-MONITOR-2.PV"
        ...
        sTags(0) = "XHN_GAS-PLNT_TRN-3_QNCH-H2O-FLTR_DP.PV"
        sTags(1) = "XHN_GAS-PLNT_TRN-3_QNCH-COLUMN_CHMBR-DP.PV"
        sTags(2) = "XHN_GAS-PLNT_TRN-3_SCOT-ABSORBR_CHMBR-DP.PV"
        sTags(3) = "XHN_GAS-PLNT_TRN-3_SCOT-REACTR_DP.PV"
        sTags(4) = "XHN_GAS-PLNT_TRN-3_SOUR-H2O-STRIP_CHMBR-DP.PV"
        '  sTags(4) = "XHN_GS-B_ACID-GAS-COMP-1_STG-5-DP.PV"
        ...
        pi_col_xls_tags(1) = "XHN_GAS-PLNT_TRN-3_QNCH-H2O-FLTR_DP.PV"
        pi_col_xls_tags(2) = "XHN_GAS-PLNT_TRN-3_QNCH-COLUMN_CHMBR-DP.PV"
        pi_col_xls_tags(3) = "XHN_GAS-PLNT_TRN-3_SCOT-ABSORBR_CHMBR-DP.PV"
        pi_col_xls_tags(4) = "XHN_GAS-PLNT_TRN-3_SCOT-REACTR_DP.PV"
        pi_col_xls_tags(5) = "XHN_GAS-PLNT_TRN-3_SOUR-H2O-STRIP_CHMBR-DP.PV"
        '  pi_col_xls_tags(5) = "XHN_GS-B_ACID-GAS-COMP-1_STG-5-DP.PV"
    ...
    Private Sub createNewChart(ByRef cha As Chart, ByVal chaName As String, ByVal iLeft As Integer, ByVal iTop As Integer,
        ...
        myXax.IntervalType = IntervalTypes.Hours
        myXax.Interval = 2
    ...
    Private Sub Scot_3_Loaded(sender As Object, e As RoutedEventArgs) Handles Me.Loaded
    ...
    Private Sub Scot_3_SizeChanged(sender As Object, e As SizeChangedEventArgs) Handles Me.SizeChanged
        oTransform1.BeginAnimation(RotateTransform.AngleProperty, oWeelAuto1)
        oTransform0.BeginAnimation(RotateTransform.AngleProperty, oWeelAuto0)
