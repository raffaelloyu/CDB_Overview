...
Public Class WellPadC
    ...
    Public Sub createPage(ByVal sArea As String, ByVal sPipe As String, ByVal sPageType As String)
        ...
        If sPageType = "WellPadC" Then
            Call createWellPadC()
        End If

    End Sub
    Private Sub createWellPadC()
        Dim sTags(1) As String

        sTags(0) = "XHN_WP-C_LJ-14_IFRT.PV"
        sTags(1) = "XHN_WP-C_LJ-14_IFRT_CALC.PV"
        ...
        pi_col_xls_tags(1) = "XHN_WP-C_LJ-14_IFRT.PV"
        pi_col_xls_tags(2) = "XHN_WP-C_LJ-14_IFRT_CALC.PV"
        ...
        sTags(0) = "XHN_WP-C_LJ-15_IFRT.PV"
        sTags(1) = "XHN_WP-C_LJ-15_IFRT_CALC.PV"
        ...
        pi_col_xls_tags(1) = "XHN_WP-C_LJ-15_IFRT.PV"
        pi_col_xls_tags(2) = "XHN_WP-C_LJ-15_IFRT_CALC.PV"
        ...
        sTags(0) = "XHN_WP-C_LJ-20_IFRT.PV"
        sTags(1) = "XHN_WP-C_LJ-20_IFRT_CALC.PV"
        '  sTags(2) = "FIC070922_1.DACA.PV"
        '  sTags(3) = "FIC070642_1.DACA.PV"
        '   sTags(3) = "XHN_GS-B_ACID-GAS-COMP-1_STG-4-DP.PV"
        '  sTags(4) = "XHN_GS-B_ACID-GAS-COMP-1_STG-5-DP.PV"
        ...
        pi_col_xls_tags(1) = "XHN_WP-C_LJ-20_IFRT.PV"
        pi_col_xls_tags(2) = "XHN_WP-C_LJ-20_IFRT_CALC.PV"
        '  pi_col_xls_tags(3) = "FIC070922_1.DACA.PV"
        '  pi_col_xls_tags(4) = "FIC070642_1.DACA.PV"
        ' pi_col_xls_tags(4) = "XHN_GS-B_ACID-GAS-COMP-1_STG-4-DP.PV"
        '  pi_col_xls_tags(5) = "XHN_GS-B_ACID-GAS-COMP-1_STG-5-DP.PV"
    ...
    Private Sub refreshChart(ByVal sChartName As String, ByVal ipt As Integer)
        ...
        sSeriesNames(1) = "LJ-14 Measured Flow"
        sSeriesNames(2) = "LJ-14 Calculated Flow"
        ...
        If sChartName = "chart_flows_lean" Then
            ...
            sSeriesNames(1) = "LJ-15 Measured Flow"
            sSeriesNames(2) = "LJ-15 Calculated Flow"
        ...
        ElseIf sChartName = "chart_flows_acid" Then
            ...
            sSeriesNames(1) = "LJ-20 Measured Flow"
            sSeriesNames(2) = "LJ-20 Calculated Flow"
        End If
    ...
    Private Sub WellPadC_SizeChanged(sender As Object, e As SizeChangedEventArgs) Handles Me.SizeChanged
