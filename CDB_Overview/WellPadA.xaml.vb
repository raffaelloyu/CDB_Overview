...
Public Class WellPadA
    ...
    Public Sub createPage(ByVal sArea As String, ByVal sPipe As String, ByVal sPageType As String)
        ...
        If sPageType = "WellPadA" Then
            Call createWellPadA()
        End If

    End Sub
    Private Sub createWellPadA()
        Dim sTags(1) As String

        sTags(0) = "XHN_WP-A_LJ-11H_IFRT.PV"
        sTags(1) = "XHN_WP-A_LJ-11H_IFRT_CALC.PV"
        ...
        pi_col_xls_tags(1) = "XHN_WP-A_LJ-11H_IFRT.PV"
        pi_col_xls_tags(2) = "XHN_WP-A_LJ-11H_IFRT_CALC.PV"
        ...
        sTags(0) = "XHN_WP-A_LJ-12H_IFRT.PV"
        sTags(1) = "XHN_WP-A_LJ-12H_IFRT_CALC.PV"
        ...
        pi_col_xls_tags(1) = "XHN_WP-A_LJ-12H_IFRT.PV"
        pi_col_xls_tags(2) = "XHN_WP-A_LJ-12H_IFRT_CALC.PV"
        ...
        sTags(0) = "XHN_WP-A_LJ-13H_IFRT.PV"
        sTags(1) = "XHN_WP-A_LJ-13H_IFRT_CALC.PV"
        '  sTags(2) = "FIC070922_1.DACA.PV"
        '  sTags(3) = "FIC070642_1.DACA.PV"
        '   sTags(3) = "XHN_GS-B_ACID-GAS-COMP-1_STG-4-DP.PV"
        '  sTags(4) = "XHN_GS-B_ACID-GAS-COMP-1_STG-5-DP.PV"
        ...
        pi_col_xls_tags(1) = "XHN_WP-A_LJ-13H_IFRT.PV"
        pi_col_xls_tags(2) = "XHN_WP-A_LJ-13H_IFRT_CALC.PV"
        '  pi_col_xls_tags(3) = "FIC070922_1.DACA.PV"
        '  pi_col_xls_tags(4) = "FIC070642_1.DACA.PV"
        ' pi_col_xls_tags(4) = "XHN_GS-B_ACID-GAS-COMP-1_STG-4-DP.PV"
        '  pi_col_xls_tags(5) = "XHN_GS-B_ACID-GAS-COMP-1_STG-5-DP.PV"
    ...
    Private Sub refreshChart(ByVal sChartName As String, ByVal ipt As Integer)
        ...
        'Height="253" Canvas.Left="766" Stroke="Gray" Canvas.Top="12" Width="557"
        ...
        sSeriesNames(1) = "LJ-11H Measured Flow"
        sSeriesNames(2) = "LJ-11H Calculated Flow"
        ...
        If sChartName = "chart_flows_lean" Then
            ...
            sSeriesNames(1) = "LJ-12H Measured Flow"
            sSeriesNames(2) = "LJ-12H Calculated Flow"
        ...
        ElseIf sChartName = "chart_flows_acid" Then
            ...
            sSeriesNames(1) = "LJ-13H Measured Flow"
            sSeriesNames(2) = "LJ-13H Calculated Flow"
        End If
    ...
    Sub newelem_PropertyChanged(ByVal sender As Object, ByVal e As PropertyChangedEventArgs)
        ...
        End If
    End Sub
    Private Sub WellPadA_SizeChanged(sender As Object, e As SizeChangedEventArgs) Handles Me.SizeChanged
