...
Public Class SulfurRemoval1
    ' Private oWeelAuto As New DoubleAnimation
    ...
    Public Sub New()
        ...
        '  oWeelAuto.RepeatBehavior = New RepeatBehavior(100)
        ...
        'Dim imgTemp, imgTemp1 As Image

        '    For i = 1 To 3
        '        imgTemp = LogicalTreeHelper.FindLogicalNode(mycanvas, "imgWell_front" & i)
        '    imgTemp1 = LogicalTreeHelper.FindLogicalNode(mycanvas, "imgWell_rear" & i)

        '   imgTemp.RenderTransform = oTransform1
        '   imgTemp1.RenderTransform = oTransform1
        '    Next
        '  imgWell_front1.RenderTransform = oTransform1
        ' imgWell_rear1.RenderTransform = oTransform1
    ...
    Public Sub createPage(ByVal sArea As String, ByVal sPipe As String, ByVal sPageType As String)
        ...
        If sPageType = "SulfurRemoval1" Then
    ...
    Private Sub createTEGCompressor()
        ...
        sTags(0) = "FIC070602_1.DACA.PV"
        sTags(1) = "XHN_GAS-PLNT_TRN-1_WET-TREAT-GAS-KO-DRUM_GAS-OUTLET-IFRT.PV"
        ...
        pi_col_xls_tags(1) = "FIC070602_1.DACA.PV"
        pi_col_xls_tags(2) = "XHN_GAS-PLNT_TRN-1_WET-TREAT-GAS-KO-DRUM_GAS-OUTLET-IFRT.PV"
        ...
        sTags(0) = "XHN_GAS-PLNT_TRN-1_LEAN-SLFNL-COOLR_INLET-IFRT.PV"
        sTags(1) = "XHN_GAS-PLNT_TRN-1_HP-LEAN-SLFNL-PMP_DISCH-IFRT.PV"
        ...
        pi_col_xls_tags(1) = "XHN_GAS-PLNT_TRN-1_LEAN-SLFNL-COOLR_INLET-IFRT.PV"
        pi_col_xls_tags(2) = "XHN_GAS-PLNT_TRN-1_HP-LEAN-SLFNL-PMP_DISCH-IFRT.PV"
        ...
        sTags(0) = "XHN_GAS-PLNT_TRN-1_RFLUX-DRUM_GAS-OUTLET-IFRT.PV"
        sTags(1) = "XHN_GAS-PLNT_TRN-1_FLASH-GAS-ABSORBR_GAS-OUTLET-IFRT.PV"
        '  sTags(2) = "FIC070922_1.DACA.PV"
        '  sTags(3) = "FIC070642_1.DACA.PV"
        '   sTags(3) = "XHN_GS-B_ACID-GAS-COMP-1_STG-4-DP.PV"
        '  sTags(4) = "XHN_GS-B_ACID-GAS-COMP-1_STG-5-DP.PV"
        ...
        pi_col_xls_tags(1) = "XHN_GAS-PLNT_TRN-1_RFLUX-DRUM_GAS-OUTLET-IFRT.PV"
        pi_col_xls_tags(2) = "XHN_GAS-PLNT_TRN-1_FLASH-GAS-ABSORBR_GAS-OUTLET-IFRT.PV"
        '  pi_col_xls_tags(3) = "FIC070922_1.DACA.PV"
        '  pi_col_xls_tags(4) = "FIC070642_1.DACA.PV"
        ' pi_col_xls_tags(4) = "XHN_GS-B_ACID-GAS-COMP-1_STG-4-DP.PV"
        '  pi_col_xls_tags(5) = "XHN_GS-B_ACID-GAS-COMP-1_STG-5-DP.PV"
    ...
    Private Sub refreshChart(ByVal sChartName As String, ByVal ipt As Integer)
        ...
        ' Height="203" Canvas.Left="20" Canvas.Top="697" Width="426"
        'Height="210" Canvas.Left="8" Canvas.Top="695" Width="550"
        ...
        sSeriesNames(1) = "Sour Gas"
        sSeriesNames(2) = "Treated Gas"

        If sChartName = "chart_flows_lean" Then
            'Height="203" Canvas.Left="459" Canvas.Top="697" Width="426"
            'Height="210" Canvas.Left="564" Canvas.Top="695" Width="550"
            ...
            sSeriesNames(1) = "Lean Total"
            sSeriesNames(2) = "to Main Absorber"
                ...
                Else
                    If curval.GetType.Name = "AFEnumerationValue" Then
                        ...
                        ElseIf curval.ToString = "STOP" Or curval.ToString = "OFF" Then
                            element.SelectSingleNode("cursta").InnerText = "closed"
                        ElseIf curval.ToString = "MAN" Then
                            element.SelectSingleNode("cursta").InnerText = "man"
                        ElseIf curval.ToString = "CAS" Then
                            element.SelectSingleNode("cursta").InnerText = "cas"
                        ElseIf lcase(curval.ToString) = "auto" Then
                            element.SelectSingleNode("cursta").InnerText = "auto"
                        Else
                            element.SelectSingleNode("cursta").InnerText = "error"
                        End If
                    Else
